...
void main() {
  group('NotificationService', () {
    ...
    group('Configuración', () {
      ...
      test(
        'puede deshabilitar notificaciones',
        skip: 'Requiere plugin nativo para cancelAll()',
        () async {
      ...
      test(
        'puede habilitar recordatorios recurrentes',
        skip: 'Requiere plugin nativo en dispositivo real',
        () async {
          await service.setRecurringRemindersEnabled(true);
        },
      );

      test(
        'puede configurar recordatorio diario',
        skip: 'Requiere plugin nativo en dispositivo real',
        () async {
