...
class ChartService {
  ...
  List<MonthlyTrendData> calculateMonthlyTrend({
    required List<List<TransactionEntry>> transactionsByMonth,
  ...
  PeriodComparison calculateMonthComparison({
    required List<TransactionEntry> currentMonthTransactions,
    required List<TransactionEntry> previousMonthTransactions,
  }) {
