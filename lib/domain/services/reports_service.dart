...
class ReportsService {
  ...
  Future<BalanceSheet> generateBalanceSheet() async {
  ...
  Future<CashFlowReport> generateCashFlowReport({
    required DateTime startDate,
    required DateTime endDate,
  }) async {
    final transactions = await transactionsDao.getTransactionsInPeriod(
  ...
  Future<MonthlySummary> generateMonthlySummary({
    required int year,
    required int month,
  }) async {
    ...
    final transactionCount = await transactionsDao
