...
class _GoalCard extends ConsumerWidget {
          ...
          child: Column(
            children: [
              Row(
                children: [
                  ...
                  Column(
                    ...
                    children: [
                      Text(
                        '${goal.progressPercentageCapped.toInt()}%',
                        style: TextStyle(
                          fontSize: 20,
                          fontWeight: FontWeight.bold,
                          color: statusColor,
              ...
              ClipRRect(
                borderRadius: BorderRadius.circular(4),
                child: LinearProgressIndicator(
                  value: (goal.progressPercentageCapped / 100).clamp(0.0, 1.0),
                  minHeight: 8,
                  backgroundColor: Colors.grey.shade200,
  ...
  void _showGoalDetails(BuildContext context, WidgetRef ref, SavingsGoal goal) {
    showModalBottomSheet(
      context: context,
      isScrollControlled: true,
              ...
              children: [
                ...
                if (goal.targetDate != null)
                  _DetailRow(
                    ...
                    valueColor: goal.isOverdue ? Colors.red : null,
                  ),
...
class _LargeProgressIndicator extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    final progress = goal.progressPercentageCapped / 100;
            ...
            SizedBox(
              ...
              child: CircularProgressIndicator(
                ...
                valueColor: AlwaysStoppedAnimation(
                  goal.hasReachedTarget ? Colors.green : Color(goal.color),
                ),
              ),
            ),
            Column(
