...
class AccountsScreen extends ConsumerWidget {
  ...
  void _openAccountForm(BuildContext context, WidgetRef ref) async {
...
class _AccountsList extends ConsumerWidget {
  final List<AccountWithCategory> accounts;
...
class _AccountTile extends ConsumerWidget {
  final AccountWithCategory accountData;
                    ...
                    Row(
                      children: [
                        ...
                        if (account.description != null &&
                          ...
                          if (!account.includeInTotal) const SizedBox(width: 8),
                          Expanded(
                            child: Text(
                              account.description!,
                              style: TextStyle(
