...
/// Provider de presupuestos del período seleccionado
final periodBudgetsProvider = FutureProvider<List<BudgetEntry>>((ref) async {
  final dao = ref.watch(budgetsDaoProvider);
  final period = ref.watch(budgetPeriodProvider);
  return dao.getBudgetsForMonth(period.month, period.year);
});
